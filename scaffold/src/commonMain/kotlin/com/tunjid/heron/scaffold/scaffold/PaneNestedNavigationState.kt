...
@Composable
fun <T : PaneScaffoldState.NestedNavigationKey> PaneScaffoldState.NestedNavigation(
    modifier: Modifier = Modifier,
    key: T,
    transitionSpec: AnimatedContentTransitionScope<T>.() -> ContentTransform = {
        DefaultNestedNavigationTransitionSpec
    },
    content: @Composable AnimatedVisibilityScope.(key: T) -> Unit,
) {
    nestedNavigationState.key = key
...
private val DefaultNestedNavigationTransitionSpec = fadeIn() togetherWith fadeOut()

...
class DataBindings(private val args: DataBindingArgs) {
    ...
    @SingleIn(AppScope::class)
    @Provides
    internal fun providePdsResolver(plcDirectoryPdsResolver: PlcDirectoryPdsResolver): PdsResolver =
        plcDirectoryPdsResolver

    @SingleIn(AppScope::class)
    @Provides
    internal fun provideOauthRedirect(): OauthRedirect = oauthRedirect()
    ...
    @SingleIn(AppScope::class)
    @Provides
    fun provideStandardSiteDao(database: AppDatabase): StandardSiteDao = database.standardSiteDao()

    @SingleIn(AppScope::class)
    @Provides
    fun provideRockskyDao(database: AppDatabase): RockskyDao = database.rockskyDao()

    @SingleIn(AppScope::class)
    @Provides
    fun provideDatabaseCleanupDao(database: AppDatabase): DatabaseCleanupDao =
        database.databaseCleanupDao()

...
internal class ThingNotificationPreferenceUpdater @Inject constructor() :
    NotificationPreferenceUpdater {

    override suspend fun update(
        notificationPreferences: Preferences,
        notifications: SavedState.Notifications,
    ): SavedState.Notifications {
        val updatedNotificationPrefs =
            NotificationPreferences(
                follow =
                    NotificationPreferences.Preference.Filterable(
                        include =
                            FilterablePreferenceInclude.safeValueOf(
                                    notificationPreferences.follow.include.value
                                )
                                .asExternalModel(),
                ...
                like =
                    NotificationPreferences.Preference.Filterable(
                        include =
                            FilterablePreferenceInclude.safeValueOf(
                                    notificationPreferences.like.include.value
                                )
                                .asExternalModel(),
                ...
                likeViaRepost =
                    NotificationPreferences.Preference.Filterable(
                        include =
                            FilterablePreferenceInclude.safeValueOf(
                                    notificationPreferences.likeViaRepost.include.value
                                )
                                .asExternalModel(),
                ...
                mention =
                    NotificationPreferences.Preference.Filterable(
                        include =
                            FilterablePreferenceInclude.safeValueOf(
                                    notificationPreferences.mention.include.value
                                )
                                .asExternalModel(),
                ...
                quote =
                    NotificationPreferences.Preference.Filterable(
                        include =
                            FilterablePreferenceInclude.safeValueOf(
                                    notificationPreferences.quote.include.value
                                )
                                .asExternalModel(),
                ...
                reply =
                    NotificationPreferences.Preference.Filterable(
                        include =
                            FilterablePreferenceInclude.safeValueOf(
                                    notificationPreferences.reply.include.value
                                )
                                .asExternalModel(),
                ...
                repost =
                    NotificationPreferences.Preference.Filterable(
                        include =
                            FilterablePreferenceInclude.safeValueOf(
                                    notificationPreferences.repost.include.value
                                )
                                .asExternalModel(),
                ...
                repostViaRepost =
                    NotificationPreferences.Preference.Filterable(
                        include =
                            FilterablePreferenceInclude.safeValueOf(
                                    notificationPreferences.repostViaRepost.include.value
                                )
                                .asExternalModel(),

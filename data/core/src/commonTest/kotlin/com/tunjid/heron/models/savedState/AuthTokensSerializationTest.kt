...
@Burst
class AuthTokensSerializationTest(
    ...
    val original: SavedState.AuthTokens = burstValues(
        SampleSavedStateData.guestAuth(),
        SampleSavedStateData.bearerAuth(),
        SampleSavedStateData.dpopAuth(),
    ),
) {
    @Test
    fun roundTrip() {

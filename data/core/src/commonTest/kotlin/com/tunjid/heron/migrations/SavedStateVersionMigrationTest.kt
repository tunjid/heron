...
internal class SavedStateVersionMigrationTest(
    val oldVersion: SavedStateVersion =
        burstValues(
    ...
    fun migrateToLatestVersion_noDataLoss() = runBlocking {
        val encoded =
            when (oldVersion) {
                is SavedStateVersion0 ->
                    SavedStateSerializationHelper.encode(
                        oldVersion,
                        SavedStateVersion0.serializer(),
                    )
                is SavedStateVersion1 ->
                    SavedStateSerializationHelper.encode(
                        oldVersion,
                        SavedStateVersion1.serializer(),
                    )
                is SavedStateVersion2 ->
                    SavedStateSerializationHelper.encode(
                        oldVersion,
                        SavedStateVersion2.serializer(),
                    )
                is SavedStateVersion3 ->
                    SavedStateSerializationHelper.encode(
                        oldVersion,
                        SavedStateVersion3.serializer(),
                    )
                is SavedStateVersion4 ->
                    SavedStateSerializationHelper.encode(
                        oldVersion,
                        SavedStateVersion4.serializer(),
                    )
                is SavedStateVersion5 ->
                    SavedStateSerializationHelper.encode(
                        oldVersion,
                        SavedStateVersion5.serializer(),
                    )
                is SavedStateVersion6 ->
                    SavedStateSerializationHelper.encode(
                        oldVersion,
                        SavedStateVersion6.serializer(),
                    )
            }
...
private fun sampleVersion0UnAuth() =
    SavedStateVersion0(
        auth = null,
...
private fun sampleVersion0BearerAuth() =
    SavedStateVersion0(
        auth =
            SavedStateVersion0.AuthTokensV0(
...
private fun sampleVersion1BearerAuth() =
    SavedStateVersion1(
        version = 1,
        auth =
            SavedStateVersion1.AuthTokensV1(
...
private fun sampleVersion2BearerAuth() =
    SavedStateVersion2(
        version = 2,
        auth =
            SavedStateVersion2.AuthTokensV2.Authenticated.Bearer(
                authProfileId = ProfileId("id2"),
                auth = "token2",
                refresh = "refresh2",
            ),
...
private fun sampleVersion2GuestAuth() =
    SavedStateVersion2(
        version = 2,
...
private fun sampleVersion3GuestAuth() =
    SavedStateVersion3(
        version = 3,
...
private fun sampleVersion3BearerAuth() =
    SavedStateVersion3(
        version = 3,
        auth =

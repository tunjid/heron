...
data class StandardPublicationEntity(
    @PrimaryKey val uri: StandardPublicationUri,
    ...
    val url: String,
    val icon: ImageUri?,
    @Embedded(prefix = "preferences_") val preferences: Preferences?,
    @Embedded(prefix = "theme_") val basicTheme: BasicTheme?,
    @ColumnInfo(defaultValue = "0") val sortedAt: Instant,
) {
    data class Preferences(val showInDiscover: Boolean)

    data class BasicTheme(
        @Embedded(prefix = "accent_") val accent: Color?,
        @Embedded(prefix = "accentFg_") val accentForeground: Color?,
        @Embedded(prefix = "bg_") val background: Color?,
        @Embedded(prefix = "fg_") val foreground: Color?,
    )
...
data class PopulatedStandardPublicationEntity(
    @Embedded val entity: StandardPublicationEntity,
...
fun PopulatedStandardPublicationEntity.asExternalModel() =

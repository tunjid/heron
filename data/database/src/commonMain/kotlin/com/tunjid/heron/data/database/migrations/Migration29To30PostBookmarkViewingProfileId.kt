...
internal object Migration29To30PostBookmarkViewingProfileId : Migration(29, 30) {
    override fun migrate(connection: SQLiteConnection) {
        ...
        connection.execSQL(
            "CREATE INDEX IF NOT EXISTS index_bookmarks_bookmarkedUri ON bookmarks (bookmarkedUri)"
        )
        connection.execSQL(
            "CREATE INDEX IF NOT EXISTS index_bookmarks_viewingProfileId_createdAt ON bookmarks (viewingProfileId, createdAt)"
        )
    }
}

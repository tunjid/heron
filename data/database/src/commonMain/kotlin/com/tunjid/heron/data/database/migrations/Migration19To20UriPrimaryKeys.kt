...
internal object Migration19To20UriPrimaryKeys : Migration(19, 20) {
    override fun migrate(connection: SQLiteConnection) {
        ...
        connection.execSQL(
            "CREATE INDEX `index_feedGenerators_creatorId` ON feedGenerators (`creatorId`);"
        )
        connection.execSQL(
            "CREATE INDEX `index_feedGenerators_indexedAt` ON feedGenerators (`indexedAt`);"
        )
        connection.execSQL(
        ...
        connection.execSQL(
            "CREATE INDEX `index_starterPacks_creatorId` ON starterPacks (`creatorId`);"
        )
        connection.execSQL(
            "CREATE INDEX `index_starterPacks_indexedAt` ON starterPacks (`indexedAt`);"
        )
        connection.execSQL(
        ...
        connection.execSQL(
            "CREATE INDEX `index_postReposts_indexedAt` ON postReposts (`indexedAt`);"
        )
        ...
        connection.execSQL(
            "CREATE INDEX `index_postThreads_parentPostUri` ON postThreads (`parentPostUri`);"
        )
        ...
        connection.execSQL(
            "CREATE INDEX `index_timelineItems_postUri` ON timelineItems (`postUri`);"
        )
        connection.execSQL(
            "CREATE INDEX `index_timelineItems_indexedAt` ON timelineItems (`indexedAt`);"
        )
        connection.execSQL(
        ...
        connection.execSQL(
            "CREATE INDEX `index_timelineItems_rootPostUri` ON timelineItems (`rootPostUri`);"
        )
        connection.execSQL(
            "CREATE INDEX `index_timelineItems_parentPostUri` ON timelineItems (`parentPostUri`);"
        )
        connection.execSQL(
            "CREATE INDEX `index_timelineItems_grandParentPostAuthorId` ON timelineItems (`grandParentPostAuthorId`);"
        )
        ...
        connection.execSQL(
            "CREATE INDEX `index_postPosts_embeddedPostUri` ON postPosts (`embeddedPostUri`);"
        )
        ...
        connection.execSQL(
            "CREATE INDEX `index_postViewerStatistics_postUri` ON postViewerStatistics (`postUri`);"
        )
        connection.execSQL(
            "CREATE INDEX `index_postViewerStatistics_viewingProfileId` ON postViewerStatistics (`viewingProfileId`);"
        )
        ...
        connection.execSQL(
            "CREATE INDEX `index_postExternalEmbeds_postUri` ON postExternalEmbeds (`postUri`);"
        )
        connection.execSQL(
            "CREATE INDEX `index_postExternalEmbeds_externalEmbedUri` ON postExternalEmbeds (`externalEmbedUri`);"
        )
        ...
        connection.execSQL(
            "CREATE INDEX `index_messagePosts_messageId` ON messagePosts (`messageId`);"
        )
        ...
        connection.execSQL(
            "CREATE INDEX `index_messageLists_messageId` ON messageLists (`messageId`);"
        )
        ...
        connection.execSQL(
            "CREATE INDEX `index_messageStarterPacks_messageId` ON messageStarterPacks (`messageId`);"
        )
        connection.execSQL(
            "CREATE INDEX `index_messageStarterPacks_starterPackUri` ON messageStarterPacks (`starterPackUri`);"
        )
        ...
        connection.execSQL(
            "CREATE INDEX `index_messageFeedGenerators_messageId` ON messageFeedGenerators (`messageId`);"
        )
        connection.execSQL(
            "CREATE INDEX `index_messageFeedGenerators_feedGeneratorUri` ON messageFeedGenerators (`feedGeneratorUri`);"
        )
    }
}

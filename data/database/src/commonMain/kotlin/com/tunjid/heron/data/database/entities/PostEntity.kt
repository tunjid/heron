...
@Entity(
    ...
    indices = [Index(value = ["uri"]), Index(value = ["cid"]), Index(value = ["authorId"])],
)
...
fun stubPostEntity(id: PostId, uri: PostUri, authorId: ProfileId) =
    PostEntity(
        cid = id,
        uri = uri,
        authorId = authorId,
...
data class PopulatedPostEntity(
    ...
    @Relation(
        ...
        entityColumn = "uri",
        associateBy =
            Junction(value = ProfileEntity::class, parentColumn = "did", entityColumn = "did"),
    )
...
fun PopulatedPostEntity.asExternalModel(embeddedRecord: Record.Embeddable?) =
    Post(
        cid = entity.cid,
        uri = entity.uri,
        ...
        author =
            author.asExternalModel(labels = authorLabelEntities.map(LabelEntity::asExternalModel)),
        embed =
            when {

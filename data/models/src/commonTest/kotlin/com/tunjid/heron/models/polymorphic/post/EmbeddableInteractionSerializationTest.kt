...
class EmbeddableInteractionSerializationTest(
    ...
    val original: Post.Interaction = burstValues(
        ...
        Post.Interaction.Delete.Unlike(PostUri("at://post/unlike"), GenericUri("at://like/1")),
        Post.Interaction.Delete.RemoveRepost(PostUri("at://post/removeRepost"), GenericUri("at://repost/1")),

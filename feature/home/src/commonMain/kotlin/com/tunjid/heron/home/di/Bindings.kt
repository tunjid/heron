...
object HomeBindings {
    ...
    @Provides
    @IntoMap
    @ClassKey(HomeStateHolder::class)
...
internal fun Route(
    ...
    val stateHolder = paneScaffoldState.retainRouteStateHolder<HomeStateHolder>(
        route = route,
    )
        ...
        floatingActionButton = {
            PaneFab(
                ...
                icon = when {
                    ...
                    state.tabLayout is TabLayout.Expanded -> HeronIcons.Regular.Save
                    else -> HeronIcons.Regular.Edit
                },

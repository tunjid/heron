...
fun AnalysisFilter(
    ...
    if (filter is Filter.Analysis.TextArbitrary || filter is Filter.Analysis.ImageArbitrary) {
        return UnsupportedFilter(modifier = modifier, title = title, onRemove = onRemove)
    }
    ...
    StandardFilter(
        ...
        startContent = {
            when (filter) {
                ...
                is Filter.Analysis.TextArbitrary ->
                    Dropdown(
                        label = categoryLabel,
                        selected = filter.category,
                ...
                is Filter.Analysis.ImageArbitrary ->
                    Dropdown(
                        label = categoryLabel,
                        selected = filter.category,
                ...
                onSelect = { newOperator ->
                    onUpdate(
                        when (filter) {
                            ...
                            is Filter.Analysis.FinancialSentiment ->
                                filter.copy(operator = newOperator)
                ...
                onThresholdChanged = { threshold ->
                    onUpdate(
                        when (filter) {
                            ...
                            is Filter.Analysis.FinancialSentiment ->
                                filter.copy(threshold = threshold)
...
fun Filter.Analysis.Language.Category.stringRes(): StringResource =
    when (this) {
...
fun Filter.Analysis.Sentiment.Category.stringRes(): StringResource =
    when (this) {
...
fun Filter.Analysis.FinancialSentiment.Category.stringRes(): StringResource =
    when (this) {
        Filter.Analysis.FinancialSentiment.Category.Positive ->
            Res.string.analysis_sentiment_positive
        Filter.Analysis.FinancialSentiment.Category.Negative ->
            Res.string.analysis_sentiment_negative
        Filter.Analysis.FinancialSentiment.Category.Neutral -> Res.string.analysis_sentiment_neutral
        else -> Res.string.moderation_category_unknown
    }

fun Filter.Analysis.Emotion.Category.stringRes(): StringResource =
    when (this) {
        ...
        Filter.Analysis.Emotion.Category.Disappointment ->
            Res.string.analysis_emotion_disappointment
...
fun Filter.Analysis.Toxicity.Category.stringRes(): StringResource =
    when (this) {
        Filter.Analysis.Toxicity.Category.Toxic -> Res.string.analysis_toxicity_toxic
        Filter.Analysis.Toxicity.Category.SevereToxicity ->
            Res.string.analysis_toxicity_severe_toxicity
...
fun Filter.Analysis.Topic.Category.stringRes(): StringResource =
    when (this) {
        Filter.Analysis.Topic.Category.ArtsAndCulture -> Res.string.analysis_topic_arts_culture
        Filter.Analysis.Topic.Category.BusinessAndEntrepreneurs ->
            Res.string.analysis_topic_business_entrepreneurs
        Filter.Analysis.Topic.Category.CelebrityAndPopCulture ->
            Res.string.analysis_topic_celebrity_pop_culture
        Filter.Analysis.Topic.Category.DiariesAndDailyLife ->
            Res.string.analysis_topic_diaries_daily_life
        ...
        Filter.Analysis.Topic.Category.LearningAndEducational ->
            Res.string.analysis_topic_learning_educational
        Filter.Analysis.Topic.Category.Music -> Res.string.analysis_topic_music
        Filter.Analysis.Topic.Category.NewsAndSocialConcern ->
            Res.string.analysis_topic_news_social_concern
        ...
        Filter.Analysis.Topic.Category.ScienceAndTechnology ->
            Res.string.analysis_topic_science_technology
        Filter.Analysis.Topic.Category.Sports -> Res.string.analysis_topic_sports
        Filter.Analysis.Topic.Category.TravelAndAdventure ->
            Res.string.analysis_topic_travel_adventure
        Filter.Analysis.Topic.Category.YouthAndStudentLife ->
            Res.string.analysis_topic_youth_student_life
        else -> Res.string.moderation_category_unknown
    }

fun Filter.Analysis.TextArbitrary.Category.stringRes(): StringResource =
    when (this) {
        Filter.Analysis.TextArbitrary.Category.Default -> Res.string.analysis_arbitrary_default
        else -> Res.string.moderation_category_unknown
    }

fun Filter.Analysis.ImageNsfw.Category.stringRes(): StringResource =
    when (this) {
...
fun Filter.Analysis.ImageArbitrary.Category.stringRes(): StringResource =
    when (this) {

...
package com.tunjid.heron.tasks.di
...
import com.tunjid.heron.tasks.RouteViewModelInitializer
...
import heron.feature.tasks.generated.resources.tasks
import org.jetbrains.compose.resources.stringResource

private const val TasksRoutePattern = "/tasks"
...
@BindingContainer
object TasksNavigationBindings {

    @Provides
    @IntoMap
    @StringKey(TasksRoutePattern)
    fun provideRouteMatcher(): RouteMatcher =
        urlRouteMatcher(
            routePattern = TasksRoutePattern,
...
class TasksBindings(
    ...
    private fun routePaneEntry(
        ...
        render = { route ->
            val stateHolder: TasksStateHolder = viewModel<ActualTasksViewModel> {

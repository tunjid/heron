...
object NotificationSettingsBindings {

    @Provides
    @IntoMap
    @ClassKey(NotificationSettingsStateHolder::class)
...
internal fun Route(
    ...
    val stateHolder = paneScaffoldState.retainRouteStateHolder<NotificationSettingsStateHolder>(
        route = route,
    )

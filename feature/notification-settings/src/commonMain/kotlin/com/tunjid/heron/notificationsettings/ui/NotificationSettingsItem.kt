    ...
    this?.let { prefs ->
        listOf(
            NotificationSettingItem.Filterable(
                ...
                preference = pendingUpdates[Notification.Reason.Like].pendingOrDefault(prefs.like),
            ...
            NotificationSettingItem.Filterable(
                ...
                preference =
                    pendingUpdates[Notification.Reason.Follow].pendingOrDefault(prefs.follow),
            ...
            NotificationSettingItem.Filterable(
                ...
                preference =
                    pendingUpdates[Notification.Reason.Reply].pendingOrDefault(prefs.reply),
            ...
            NotificationSettingItem.Filterable(
                ...
                preference =
                    pendingUpdates[Notification.Reason.Mention].pendingOrDefault(prefs.mention),
            ...
            NotificationSettingItem.Filterable(
                ...
                preference =
                    pendingUpdates[Notification.Reason.Quote].pendingOrDefault(prefs.quote),
            ...
            NotificationSettingItem.Filterable(
                ...
                preference =
                    pendingUpdates[Notification.Reason.Repost].pendingOrDefault(prefs.repost),
            ...
            NotificationSettingItem.ActivityFromOthers(
                ...
                preferences =
                    mapOf(
                        Notification.Reason.Verified to
                            pendingUpdates[Notification.Reason.Verified].pendingOrDefault(
                                prefs.verified
                            ),
                        Notification.Reason.Unverified to
                            pendingUpdates[Notification.Reason.Unverified].pendingOrDefault(
                                prefs.unverified
                            ),
                    ),
            ),
            NotificationSettingItem.Filterable(
                ...
                preference =
                    pendingUpdates[Notification.Reason.LikeViaRepost].pendingOrDefault(
                        prefs.likeViaRepost
                    ),
            ...
            NotificationSettingItem.Filterable(
                ...
                preference =
                    pendingUpdates[Notification.Reason.RepostViaRepost].pendingOrDefault(
                        prefs.repostViaRepost
                    ),
            ...
            NotificationSettingItem.EverythingElse(
                ...
                preferences =
                    mapOf(
                        Notification.Reason.JoinedStarterPack to
                            pendingUpdates[Notification.Reason.JoinedStarterPack].pendingOrDefault(
                                prefs.joinedStarterPack
                            ),
                        Notification.Reason.SubscribedPost to
                            pendingUpdates[Notification.Reason.SubscribedPost].pendingOrDefault(
...
private inline fun <reified T : NotificationPreferences.Preference> NotificationPreferences.Update?
    .pendingOrDefault(existingPreference: T): T =
    this?.let {
        when (existingPreference) {
            is NotificationPreferences.Preference.Filterable ->
                NotificationPreferences.Preference.Filterable(
                    include = it.include ?: existingPreference.include,
                    list = it.list,
                    push = it.push,
                )
            is NotificationPreferences.Preference.Simple ->
                NotificationPreferences.Preference.Simple(list = it.list, push = it.push)
        }
            as T
    } ?: existingPreference

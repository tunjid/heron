        ...
        icon = {
            Icon(
                ...
                contentDescription = stringResource(
                    when (notification) {
                        is Notification.Liked.OriginalPost -> Res.string.liked_your_post_description
                    ...
                    Text(
                        ...
                        text = notificationText(
                            ...
                            singularResource = when (notification) {
                                is Notification.Liked.OriginalPost -> Res.string.liked_your_post
                                is Notification.Liked.Repost -> Res.string.liked_your_repost
                            },
                            pluralResource = when (notification) {
                                is Notification.Liked.OriginalPost -> Res.string.multiple_liked_your_post

...
data class State(
    ...
    @Transient val dismissedEmbedUrl: String? = null,
                    ...
                    State(
                        postText =
                            TextFieldValue(
                                ...
                                selection =
                                    TextRange(
                                        if (model is Post.Create.Mention)
                                            model.profile.handle.id.length + 2
                                        else 0
                                    ),
                            ),
...
sealed class Action(val key: String) {
    ...
    data class EmbedUrl(val url: String) : Action("EmbedUrl")
    ...
    data class RemoveEmbeddedRecord(val url: String? = null) : Action("RemoveEmbeddedRecord")

...
val HeronIcons.Forward5: ImageVector
    get() {
        if (_forward5 != null) {
            return _forward5!!
        }
        _forward5 = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                curveToRelative(0.24f, 0f, 0.46f, -0.04f, 0.64f, -0.12f)
                ...
                curveToRelative(0f, -0.22f, -0.03f, -0.43f, -0.09f, -0.6f)
                ...
                curveToRelative(0.12f, 0f, 0.22f, 0.02f, 0.3f, 0.05f)

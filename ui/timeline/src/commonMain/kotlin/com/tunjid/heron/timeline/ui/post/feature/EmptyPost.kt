...
private fun TimelineItem.Empty.emptyTextRes(): StringResource =
    when (this) {
        is TimelineItem.Empty.Thread -> Res.string.empty_timeline_thread
        is TimelineItem.Empty.Timeline ->
            when (val timeline = timeline) {
...
private fun TimelineItem.Empty.emptyDescriptionRes(): StringResource =
    when (this) {
                ...
                is Timeline.Profile ->
                    when (timeline.type) {
                        ...
                        Timeline.Profile.Type.Replies ->
                            Res.string.empty_timeline_replies_description
...
private fun TimelineItem.Empty.emptyIcon(): ImageVector =
    when (this) {
